-- Migration variante: cria history table e usa gen_random_uuid() (pgcrypto)
-- Atenção: requer permissão para criar extensão pgcrypto no banco

-- Cria extensão se permitido
...
-- Tabela de histórico com gen_random_uuid()
