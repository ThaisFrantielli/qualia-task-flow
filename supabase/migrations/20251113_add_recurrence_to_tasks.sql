-- Migration: Adiciona colunas de recorrência à tabela `tasks`
...
-- Indexes para melhorar buscas e geração de ocorrências
...
-- (Opcional) tabela de histórico de recorrência para auditoria
