...
const QUERY_DIM_FROTA = `SELECT 
    ...
    COALESCE(NULLIF(v.OdometroConfirmado, 0), NULLIF(v.OdometroInformado, 0), 0) as KM, 
    NULLIF(CAST(v.OdometroInformado AS INT), 0) as KmInformado,
    NULLIF(CAST(v.OdometroConfirmado AS INT), 0) as KmConfirmado,
