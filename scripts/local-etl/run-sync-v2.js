...
async function runMasterETL() {
    ...
    try {
        ...
        const factDefs = [
            ...
            {
                table: 'fat_sinistros',
                // Selecionar todas as colunas da origem para garantir que nenhum campo fique em branco
                queryGen: (year) => `SELECT os.*, COALESCE(os.NomeCliente, cli.NomeFantasia) as Cliente
