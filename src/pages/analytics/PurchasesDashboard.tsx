                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y">
                            {groupedContracts.map((c: any) => {
                                ...
                                return (
                                    <>
                                        <tr key={c.id} onClick={() => setExpandedContracts(prev => { const n = new Set(prev); if(n.has(c.id)) n.delete(c.id); else n.add(c.id); return n; })} className="hover:bg-purple-50/50 cursor-pointer">
