    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Configure a hierarquia e gerencie sua equipe</p>
        </div>
            ...
            <div className="space-y-3">
              {teamMembers.map(member => (
                <div key={member.id} className="flex items-center gap-4 p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                  ...
                  <div className="flex items-center gap-2">
                    <Button variant="ghost" size="icon" onClick={() => openEditSupervisorDialog(member)}>
      ...
      {fullHierarchy && fullHierarchy.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Todos os membros sob sua supervisão</CardDescription>
          </CardHeader>
          <CardContent>
