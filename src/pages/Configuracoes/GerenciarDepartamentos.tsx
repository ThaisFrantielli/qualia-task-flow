// src/pages/Configuracoes/GerenciarDepartamentos.tsx
...
const GerenciarDepartamentosPage: React.FC = () => {
  ...
  // Abre o diálogo de edição e carrega os membros vinculados à equipe
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Gerenciar Equipes/Departamentos</h1>
            <p className="text-gray-500">Crie e organize as equipes da sua organização</p>
          </div>
        </div>
